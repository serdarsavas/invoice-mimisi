...
if (button) {
  button.addEventListener('click', async e => {
    ...
    try {
      ...
      const recipient = jsonData.find(item => item.name === targetRecipient);
      ...
      document.querySelector('#wechatId').value = recipient.wechatId;
      document.querySelector('#phone').value = recipient.phone;
    } catch (e) {
      console.log(e);
    }
  });
